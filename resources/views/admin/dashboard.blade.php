...
@section('content')
    ...
    <div class="content">
      ...
      <!-- Tombol Tambah Data -->
      <a href="{{ route('admin.tambah') }}" class="btn btn-tambah"><i class="bi bi-plus-circle"></i> Tambah Data</a>
      ...
      <table class="table table-bordered">
        ...
        <tbody>
          <tr>
            ...
            <td>anto1234</td>
            <td>
              <a href="{{ route('admin.edit') }}" class="btn btn-primary btn-sm btn-action">
    ...
    <!-- Toast Sukses -->
    <div id="toast-sukses">Data berhasil dihapus!</div>
