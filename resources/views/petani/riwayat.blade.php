...
<div class="container-fluid d-flex flex-column">
    ...
    <div class="text-center py-2 rounded" style="background-color: #729043; color: white; margin: 20px 80px">
      <h5 class="m-0">ANALISIS JAGUNG</h5>
    </div>
    <div class="container my-4 scrollable-content" style="margin: 20px auto; flex-grow: 1; overflow-y: auto">
      <!-- Kartu 1 -->
      <div class="d-flex align-items-center justify-content-between bg-white shadow-sm rounded p-3 mb-3">
        ...
        <button class="btn" style="background-color: #729043; color: white; font-weight: bold">Simpan</button>
      </div>
      <!-- Kartu 1 -->
      <div class="d-flex align-items-center justify-content-between bg-white shadow-sm rounded p-3 mb-3">
        <div class="d-flex align-items-center">
